...
class TermPage extends StatelessWidget {
  ...
  static const text = '''
<p>この利用規約（以下，「本規約」といいます。）は，株式会社KBOY（以下，「当社」といいます。）が「FlutterWork from Flutter大学」（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
...
<ol><li>ユーザーは，本サービスの有料部分の対価として，本ウェブサイトに表示する利用料金を，Stripeの決済機能により支払うものとします。</li>
...
<p>ユーザーは，当社に直接申告することによって本サービスから退会できるものとします。</p>
