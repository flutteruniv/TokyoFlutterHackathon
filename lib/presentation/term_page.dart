...
class TermPage extends StatelessWidget {
  ...
  static const text = '''
<p>東京Flutterハッカソンは、日本において開催されるFlutterエンジニアの交流、新たなアイデアの発掘、Flutterの技術可能性の探索を目的としたハッカソンです。我々はすべての参加者にとって安全で歓迎されるような場を作ることに努めます。</p>

<p>そのためには、東京Flutterハッカソンに参加するすべての人は本行動規範を守ることを求められます。聴講者、登壇者、スポンサー、主催スタッフ含めたすべての参加者にご協力をお願いします。下記のような項目は、いずれもハラスメント行為として取り扱われます（ただし、これに限定されません）。</p>
